...
def _stage_record(stage: Any, now: str) -> dict[str, Any]:
    ...
    return {
        ...
        "max_writer_tool_calls": _int_or_none(get("max_writer_tool_calls")),
        "max_writer_output_bytes": _int_or_none(get("max_writer_output_bytes")),
        "max_handoffs": _int_or_none(get("max_handoffs")),
