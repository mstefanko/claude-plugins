...
func writeValidateBuildWorkOrder(path string, protectedPaths []any) error {
	build := map[string]any{
		"verify": []any{
			...
			map[string]any{"id": "score", "kind": "metric", "argv": []any{"./scripts/bench-json"}, "wall_clock_seconds": 10, "max_output_bytes": 1000, "metric": map[string]any{"name": "score", "direction": "higher", "min_delta_percent": 1}},
		},
	}
